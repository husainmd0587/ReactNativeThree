...
const MODEL_URL = 'https://pub-9a09ee6126034c0c9cbd772d75056b70.r2.dev/glb/mechanical/engine/engine3x_8mb.glb'
// 'https://pub-9a09ee6126034c0c9cbd772d75056b70.r2.dev/glb/mechanical/engine/engine3x.glb'


// import { useTextureLoader } from '../assets/all_textures'

function Engine3x(props) {
...
console.log(animations)
  ...
  useMemo(() => {
    ...
    useEffect(() => {
    const action = actions['AnimationStack_0']
    if (action) {
